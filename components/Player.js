...
const Player = ({ trackUri, accessToken }) => {
  ...
  return (
    <>
      <div className="bg-[#181818] flex items-center justify-between px-5 py-2.5 rounded-t-2xl relative space-x-20 md:space-x-0 overflow-x-scroll md:overflow-x-hidden scrollbar-hide">
        ...
        Controls
        <div className="inset-x-auto flex flex-col items-center w-full space-y-2 md:absolute">
          <div className="flex items-center text-[#b3b3b3] text-xl space-x-4">
            ...
            <div className="flex items-center justify-center w-8 h-8 text-black bg-white rounded-full playerIcon hover:text-black">
